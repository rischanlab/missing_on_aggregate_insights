...
k100j = k100j['Jaccard']
k384j = df[(df['k'] == 384) & (df['percentage'] == percent)]
k384j = k384j['Jaccard']
...
k100r = k100r['RBO']
k384r = df[(df['k'] == 384) & (df['percentage'] == percent)]
k384r = k384r['RBO']
...
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing on Attr & Measure to Ideal")
x = [5, 10, 15, 20, 100, 384]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
